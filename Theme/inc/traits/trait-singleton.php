...
namespace SUNSET_THEME\Inc\Traits;
/**
...
trait Singleton
{
    ...
    final public static function getInstance() 
    {
        ...
        if (! isset($instance[ $called_class ]) ) {
            ...
            /**
             * Dependent items can use the `SUNSET_THEME_singleton_init_{$called_class}` hook to execute code
             */
            //do_action( sprintf( 'SUNSET_THEME_singleton_init_%s', $called_class ) ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
